...
<head>
    ...
    <meta property="og:title" content="Teseo & Data | Portafolio">
    ...
    <title>Teseo & Data | Portafolio</title>
</head>
            ...
            <div class="project-header _pc-flex-column _flex-jc-start _pc-pd40 _sp-pd20" data-pararax01>
                <h1 class="header-heading _heading01  __inview-text01" data-pararax01-text01="0">
                    <span class="heading-main _f-futura_m _futura-lh1 _futura-nm __inview-span01">
                        Historias de éxito impulsadas por datos
                    </span>
                </h1>
            </div>
            <div class="project-archives_wrap _pc-pd40 _sp-pd20">

                <div class="project-archive-categories _pc-pd40 _sp-pd20" style="margin-bottom: 40px;">
                    <div class="categories-links_list">
                ...
                <ul class="archives-link_list">
                    ...
                    <li class="link">
                        <a href="./exito/frumentarii.php" class="_link-block01" data-pararax01>
                            ...
                            <h2 class="link-heading _link-text01" data-pararax01-text01="0.4">
                                <span class="_link-span01">
                                    Frumentarii
                                </span>
                            </h2>
                    ...
                    <li class="link">
                        <a href="./exito/alpineHabitat.php" class="_link-block01" data-pararax01>
                    ...
                    <li class="link">
                        <a href="./exito/datAlphine.php" class="_link-block01" data-pararax01>
                    ...
                    <li class="link">
                        <a href="./exito/aphroditeMedia.php" class="_link-block01" data-pararax01>
